...
import { ChartNoAxesCombined, Database, PackageOpen, Gauge, ClipboardCheck, TimerReset, Truck, LayoutGrid } from "lucide-react";
import type { LucideIcon } from "lucide-react";
import { motion } from "framer-motion";

const navItems: Array<{ href: Route; label: string; icon: LucideIcon }> = [
  { href: "/dashboard", label: "Executive Dashboard", icon: ChartNoAxesCombined },
  { href: "/data-upload", label: "Data Upload", icon: Database },
  { href: "/kpi-inbound-velocity", label: "Inbound Velocity", icon: Gauge },
  { href: "/kpi-receiving-quality", label: "Receiving Quality", icon: ClipboardCheck },
  { href: "/kpi-yard-dwell-throughput", label: "Yard Dwell & Throughput", icon: Truck },
  { href: "/kpi-fulfillment-accuracy", label: "Fulfillment Accuracy", icon: ClipboardCheck },
  { href: "/kpi-order-cycle-efficiency", label: "Order Cycle Efficiency", icon: TimerReset },
  { href: "/kpi-dispatch-backlog", label: "Dispatch Backlog", icon: TimerReset }
];
